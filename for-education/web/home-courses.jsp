...
<body>
                    ...
                    <button class="navbar-toggler" data-toggle="collapse" data-target="#secondNavbar">
                            ...
                            <div class="collapse navbar-collapse" id="secondNavbar">
                                    <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="my-plan-formation.jsp">Mi plan de formaci髇</a></li>
                                    </ul>
	...
	<!-- Este es la xzona de los cursos
		La grid se compone de cuatro columnas de col-lg-3
		en la primer columna estan los filtros y de la segunda hasta la 4ta 
		son las tarjetas de los cursos.
		despues de la primer fila (row) son puros cursos.

		Las primeras tres tarjetas de los cursoso tienen propiedades especiales para acomodarse con los filtros, 
		despues hay filas de cuatro (debajo de los filtros) y todas tienen las mimsa propiedades
	-->
	<article class="mb-2">
		<!--Esta row solo abarca los filtros y tres tarjetas de cursos-->
		<div class="row">
			<div class="col-lg-3">
				<!-- Esto es collapse de los filtros-->
			...
			<!-- Esa fue la zona de los filtros
					Comienza la zona de tarjetas de los cursos
					todas las terjetas en la clase course-card tiene 
					un mx-auto y un my-2, aparte las primeras dos tienen un 
					my-auto pero en otra division
			-->
			<div class="col-lg-3 my-auto">
				<div class="card course-card pointer mx-auto my-2" style="width: 18rem;">
					<img src="img/bitcoin.jpg" class="card-img-top" alt="...">
					<div class="card-body">
							<h5 class="card-title text-center">Curso de java</h5>
							<p class="card-text">Creado por: Kevin Jafet<br> M贸dulos:8 &nbsp;&nbsp; Duracion:9-13hrs</p>
							<center>
							 <div class="progress">
			...
			<div class="col-lg-3 my-auto">
				<div class="card course-card mx-auto my-2" style="width: 18rem;">
			...
			<div class="col-lg-3 my-auto">
				<div class="card course-card mx-auto my-2" style="width: 18rem;">
						...
						<div class="card-body">
							 <h5 class="card-title text-center">Curso de java</h5>
							 <p class="card-text">Creado por: Kevin Jafet<br> M骴ulos:8 &nbsp;&nbsp; Duracion:9-13hrs</p>
							 <center><a href="StartCourse.html" class="btn btn-primary px-4">Comenzar curso</a></center>
						</div>
				</div>
			</div>
		...
		<!-- Comienza la zona de los cursos con cuatro cursos (todas la columnas ocupadas), 
			y con las mismas propieades-->
		<div class="row m-3">
			<div class="col-lg-3">
				<div class="card course-card mx-auto my-2" style="width: 18rem;">
						<img src="img/git.jpg" class="card-img-top" alt="...">
		...
		<!-- Aquie esta la division de prieba-->
		<div class="row m-3">
			<div class="col-lg-3">
				<div class="card course-card mx-auto my-2" style="width: 18rem;">
						<img src="img/git.jpg" class="card-img-top" alt="...">
	...
	<div class="container my-5">
		<div class="row">
			<div class="col-md-5"></div>
				<div class="col-md-2">
					<input type="button" class="btn btn-outline-success mx-auto px-5" value="Ver m谩s">
				</div>
			<div class="col-md-5"></div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5">
					...
					<p style="font-size: 16px">Transformamos la educaci贸n y tecnolog铆a ayudando a
...
<script type="text/javascript">
	ScrollReveal().reveal('.course-card', { delay: 500 , origin:'bottom', distance: '100px'});
</script>
